...
channel_swap "../cp4i-demo/subscriptions/${CP4I_VERSION}/01-platform-navigator-subscription.yaml" "../multi-tenancy-gitops-services/operators/ibm-platform-navigator/values.yaml"
channel_swap "../cp4i-demo/subscriptions/${CP4I_VERSION}/02-asset-repo-subscription.yaml" "../multi-tenancy-gitops-services/operators/ibm-assetrepository-operator/values.yaml"
channel_swap "../cp4i-demo/subscriptions/${CP4I_VERSION}/03-operations-dashboard-subscription.yaml" "../multi-tenancy-gitops-services/operators/ibm-opsdashboard-operator/values.yaml"
channel_swap "../cp4i-demo/subscriptions/${CP4I_VERSION}/04-api-connect-subscription.yaml" "../multi-tenancy-gitops-services/operators/ibm-apic-operator/values.yaml"
channel_swap "../cp4i-demo/subscriptions/${CP4I_VERSION}/05-event-streams-subscription.yaml" "../multi-tenancy-gitops-services/operators/ibm-eventstreams-operator/values.yaml"
channel_swap "../cp4i-demo/subscriptions/${CP4I_VERSION}/06-mq-subscription.yaml" "../multi-tenancy-gitops-services/operators/ibm-mq-operator/values.yaml"
channel_swap "../cp4i-demo/subscriptions/${CP4I_VERSION}/07-app-connect-subscription.yaml" "../multi-tenancy-gitops-services/operators/ibm-ace-operator/values.yaml"
