...
rm "../multi-tenancy-gitops-services/operators/ibm-platform-navigator/Chart.yaml"
rm "../multi-tenancy-gitops-services/operators/ibm-assetrepository-operator/Chart.yaml"
rm "../multi-tenancy-gitops-services/operators/ibm-opsdashboard-operator/Chart.yaml"
rm "../multi-tenancy-gitops-services/operators/ibm-apic-operator/Chart.yaml"
rm "../multi-tenancy-gitops-services/operators/ibm-eventstreams-operator/Chart.yaml"
rm "../multi-tenancy-gitops-services/operators/ibm-mq-operator/Chart.yaml"
rm "../multi-tenancy-gitops-services/operators/ibm-ace-operator/Chart.yaml"
rm "../multi-tenancy-gitops-services/operators/ibm-platform-navigator/values.yaml"
rm "../multi-tenancy-gitops-services/operators/ibm-assetrepository-operator/values.yaml"
rm "../multi-tenancy-gitops-services/operators/ibm-opsdashboard-operator/values.yaml"
rm "../multi-tenancy-gitops-services/operators/ibm-apic-operator/values.yaml"
rm "../multi-tenancy-gitops-services/operators/ibm-eventstreams-operator/values.yaml"
rm "../multi-tenancy-gitops-services/operators/ibm-mq-operator/values.yaml"
rm "../multi-tenancy-gitops-services/operators/ibm-ace-operator/values.yaml"
